const messages = {
    msg: {
      title: 'ThestralCüzdan',
      password: 'Şifre',
      passwordAgain: 'Şİfre tekrar gir',
      wrongPassword: 'Mugle sahibi Api işlemi başlatılamadı, şifre yanlış olabilir',
      login_: 'Giriş ',
      logout: 'Çıkış',
      search: 'Ara',
      clearup: 'Temizle',
      ...
      loading: 'Mugle Node durumu güncelleniyor...',
      error: 'Hata',
      optional: 'Seçmeli',
      open: 'Aç',
      close: 'Kapa',
      ...
      login: {
        walletExist: 'Mevcut Mugle cüzdan verileri bulundu; lütfen orijinal şifre ile giriş yapın :-)',
        waitForLocalGnode: 'Yerel Mugle Node başlamasını bekliyor',
        selectingGnode: 'Mugle Node seçimi',
        gnode: 'Mugle node'
      },
      ...
      remove:{
        ...
        warning: 'Dikkat !',
        info: 'Cüzdanı kaldırmadan önce, bu cüzdanda Mugle olmadığından veya kurtarma ifadelerini tam olarak kaydettiğinizden emin olun.!',
        help: 'Onaylamak için aşağıdaki giriş kutusuna "kaldır" yazın',
        remove: 'Kaldır',
        success: 'Mevcut cüzdan kaldırıldı, lütfen Thestralı yeniden başlatın.'
      },
      ...
      restore:{
        ...
        recovered: 'Cüzdan başarıyla geri yüklendi ve cüzdan bakiyesi Mugle blok zincirinden senkronize edilmeye başlandı.',
      ...
      app:{
        ...
        updateMsg: 'Thestral Cüzdan  yeni bir sürümü bulundu. Lütfen güncelleyin! (Yükleyin ve orjinal programın üstüne kurun).',
      ...
      httpSend:{
        ...
        salteVersionHelp: 'Muglei gönderemediyseniz, Slate dosya modelini değiştirmeyi deneyin ve ardından yeniden gönderin',
      ...
      httpReceive: {
        ...
        failed2: 'HTTP dinleme başarısız, genel IP adresinize internetten ulaşılamıyor. Mugle göndermek ve almak için lütfen işlem dosyalarını veya Hedwig yöntemini kullanın.',
        failed3: 'IP adresiniz alınamadı, lütfen daha sonra tekrar deneyin',
        failed4: 'Yerel HTTP dinleme çalışıyor (http://127.0.0.1:6815).Ancak, genel IP adresinize İnternetten ulaşılamıyor. İşlem için dosya veya Hedwig yöntemini deneyin.',
        ip: 'Genel IPniz'
      },
      ...
      hedwig: {
        ...
        address: 'Alıcı adres',
        tip: 'Lütfen Mugle alımı sırasında cüzdanınızı çevrimiçi tutun.',
        close: 'Hedwig Durdur',
        introTitle: 'Giriş',
        intro1: 'Hedwig(v1), genel IP adresi olmayan kullanıcılar için bir geçiş hizmetidir. Mugle almak için geçici bir adres sağlar.',
        intro2: 'Birisi bu adrese Mugle gönderdiğinde, Hedwig(v1) işlemi tamamlamak için talebi Thestral cüzdanınıza iletir.',
        start: 'Başlat',
        ...
        failed3: 'Yerel Mugle Alıcı Hizmeti başlatılamadı. Lütfen cüzdanı yeniden başlatın veya daha sonra tekrar deneyin.',
        copy: 'adresi kopyala',
      ...
      check: {
        ...
        intro1: 'Cüzdan bakiyeniz Mugle blok zincirindeki bakiyeyle tutarsız olduğunda (belki işlemin iptali veya gönderim hatası vb), "Bakiye Denetle" işlevini kullanın.',
        intro2: 'Kontrol sırasında, Mugle blok zincirinin tüm harcanmamış çıktıları (UTXO) arasında, kullanabileceğiniz harcanmamış çıktıları bulun ve bakiyenizi almak için bunları ekleyin.',
      ...
      gnode:{
        ...
        removeConfirm: 'Mevcut Mugle blok verilerini kaldırdığınızdan emin misiniz?'
      },
  
      gnodeConfig:{
        warning: 'Sıradan kullanım için önerilen ayarları kullanın!',
        useLocalorNot: '(Tavsiye) Yerel Mugle Node kullanın',
        connectMethod: 'Node bağlantı metodu',
        remoteFirst: 'Önce uzak Mugle NODE kullanın. Uzak Node mevcut olmadığında, yerel Node kullanın..',
        ...
        background: '(Tavsiye) Thestral kapalıyken Mugle Node arka planda çalıştırmaya devam edin.',
        restoreToDefault: 'Varsayılan ayarlara dön',
        saved: 'Ayarlar kaydedildi ve cüzdanı yeniden başlattıktan sonra geçerli olacak.'
      },
  
      gnodeConfigModal:{
        config: 'Mugle Yerel Node Ayarları',
        title: 'Mugle node ayarları'
      },
      ...
      tor:{
        ...
        address: 'Mugle almak için Tor adresi ',
        
        tip: 'Lütfen Mugle alırken czdanı açık tutun',
        tip2: 'Başlıyor...  30-60 saniye sürebilir',
        introTitle: 'Giriş',
        intro1: 'Tor, anonim iletişim sağlamak için ücretsiz ve açık kaynaklı bir yazılımdır.',
        intro2: 'Mugle Tor üzerinden alma/gönderme anonim, güvenli ve merkezi olmayan bir işlemdir',
      ...
      gaddress:{
        ...
        tips: 'Slatepack adresi, işlemi şifrelemek ve ödeme kanıtı oluşturmak için kullanılır. Mugle blok zincirinde saklanmaz.'
      },
  
      log: {
        title: 'Dışa aktar Log',
        saveMsg: "Bugünün Thestral cüzdan log dışa aktarın.",
      }
