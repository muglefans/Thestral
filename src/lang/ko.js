const messages = {
  msg: {
    ...
    exportLog: 'Export Thestral Log',

    error: 'Error',
    login: {
      walletExist: 'mugle 지갑이 존재합니다; 원래 비밀번호로 로그인 해 주십시오:-)',
    },
    ...
    restore:{
      ...
      recovered: 'Wallet recovered, it is time to check balance from Mugle blockchain',
    ...
    app:{
      ...
      updateMsg: '새로운 버전의 Thestral 지갑이 존재합니다. 지금 업데이트 해 주시기 바랍니다.',
      yes: '예',
      no: '아니오',
    ...
    hedwig: {
      ...
      intro1: 'Hedwig(v1) is a relay service for users without a public ip. It provides a temporary address to receive mugle.',
      intro2: 'When someone send mugle to the address, Hedwig(v1) will forward the send request to your wallet. So you will get your mugle.',
      start: 'Start',
      ...
      failed3: 'Failed to start local mugle receive service, try it later maybe or restart wallet.',
      copy: 'copy address',
    ...
    check: {
      ...
      intro2: "For this reason, Mugle provides a manual check command that scans the chain's UTXO set for any outputs belonging to your wallet, and ensures they're in a consistent state with your local wallet database.",
