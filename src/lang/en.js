const messages = {
  msg: {
    ...
    wrongPassword: 'Mugle owner Api process failed to start, the password may be wrong',
    login_: 'Login',
    logout: 'Logout',
    search: 'Search',
    clearup: 'Clearup',
    ...
    cancel: 'Cancel',
    save: 'Save',
    welcome: 'Welcome to Thestral Wallet',
    msg: 'Message',
    more: 'More',
    back: 'Back',
    ...
    login: {
      walletExist: 'Found existing Mugle wallet data; please login with the original password :-)',
      waitForLocalGnode: 'Waiting for the local Mugle node to start',
      selectingGnode: 'Selecting Mugle node',
      gnode: 'Mugle node'
    },
    ...
    remove:{
      ...
      warning: 'Warning !',
      info: 'Before removing the wallet, make sure that there is no Mugle in this wallet or you have fully recorded the recovery phrase!',
      help: 'Enter "remove" into the input box below to confirm',
      remove: 'Remove',
      success: 'The current wallet has been removed, please restart Thestral.'
    },
    ...
    restore:{
      ...
      recovered: 'The wallet has been successfully restored, starting to sync the wallet balance from the Mugle blockchain.',
    ...
    app:{
      ...
      updateMsg: 'A new version of Thestral Wallet has been found. Please update Right Now! (Download it and overwrite the original program).',
    ...
    httpSend:{
      ...
      salteVersionHelp: 'If you failed to send Mugle, try to change the Slate file version then resend',
    ...
    httpReceive: {
      ...
      failed2: 'HTTP listening failed, your public IP address is not reachable from the Internet. Please use transaction files or the Hedwig method to send and receive Mugle.',
      failed3: 'Unable to obtain your IP address, please try again later',
      failed4: 'Local HTTP listening is running (http://127.0.0.1:6815). However, your public IP address cannot be reached from the Internet. Try the transaction file Or Hedwig method.',
      ip: 'Your public IP'
    },
    ...
    hedwig: {
      ...
      tip: 'Please keep wallet online during Mugle reception.',
      close: 'Stop Hedwig',
      introTitle: 'Introduction',
      intro1: 'Hedwig(v1) is a relay service for users without a public IP address. It provides a temporary address to receive Mugle.',
      intro2: 'When someone sends Mugle to this address, Hedwig(v1) forwards the request to your Thestral wallet to complete the transaction.',
      start: 'Start',
      ...
      failed3: 'Local Mugle Receiver Service failed to start. Please restart the wallet or try again later.',
      copy: 'copy address',
    ...
    check: {
      ...
      intro1: 'When your local wallet balance is inconsistent with the balance on the Mugle blockchain (maybe due to the cancellation of the transaction or sending failure, etc.), you can use the "Check Balance" function.',
      intro2: 'During the check, among all the unspent outputs (UTXO) of the Mugle blockchain, find the unspent outputs you can use and add them to get your balance.',
    ...
    gnode:{
      ...
      removeConfirm: 'Are you sure to Remove the current Mugle block data?'
    },
    ...
    gnodeConfig:{
      ...
      remoteFirst: 'Use the remote Mugle node first. When the remote node is not available, use the local node.',
      ...
      background: '(Recommend) Keep running the Mugle node in background when Thestral is closed.',
    ...
    tor:{
      ...
      intro2: 'Receiving/sending Mugle via Tor is anonymous, secure and decentralized',
    ...
    gaddress:{
      ...
      tips: 'Slatepack address is used to encrypt transaction and create payment proof. It is not stored on the Mugle blockchain.'
    },
