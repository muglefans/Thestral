const messages = {
  msg: {
    title: 'Thestral Wallet',
    password: 'Mot de passe',
    passwordAgain: 'Saisissez à nouveau le mot de passe',
    wrongPassword: 'Le processus Mugle owner Api n\'a pas pu démarrer, le mot de passe est peut-être erroné',
    login_: 'Connexion',
    logout: 'Déconnexion',
    search: 'Rehercher',
    clearup: 'Nettoyer',
    ...
    cancel: 'Annuler',
    save: 'Enregistrer',
    welcome: 'Bienvenue dans le portefeuille Thestral',
    msg: 'Message',
    more: 'Plus',
    back: 'Précédent',
    ...
    loading: 'Mise à jour de l\'état depuis le noeud Mugle...',
    error: 'Erreur',
    optional: 'Optionnel',
    open: 'Ouvrir',
    close: 'Fermer',
    ...
    login: {
      walletExist: 'Des données de portefeuille Mugle ont été trouvées. Veuillez vous connecter avec le mot de passe d\'origine :-)',
      waitForLocalGnode: 'En attente du démarrage du noeud Mugle local',
      selectingGnode: 'Sélection du noeud Mugle',
      gnode: 'Noeud Mugle'
    },
    ...
    remove:{
      ...
      warning: 'Attention !',
      info: 'Avant de supprimer le portefeuille, veuillez vous assurer qu\'il ne reste pas de Mugle dans le portefeuille actuel ou que vous avez bien sauvegardé la phrase de récupération !',
      help: 'Saisir "supprimer" dans la zone de saisie ci-dessous pour confirmer',
      remove: 'Supprimer',
      success: 'Le portefeuille actuel a été supprimé, veuillez redémarrer Thestral.'
    },
    ...
    restore:{
      ...
      reAdd: 'Ressaisir',
      recovered: 'Le portefeuille a été restauré avec succès. Le solde du portefeuille doit maintenant être synchronisé avec la blockchain Mugle.',
    ...
    app:{
      ...
      updateMsg: 'Une nouvelle version du portefeuille Thestral a été détectée. Mettez le à jour dès maintenant ! (Téléchargez le et écrasez le programme d\'origine).',
    ...
    httpReceive: {
      ...
      failed2: 'L\'écoute HTTP a échoué, votre adresse IP publique n\'est pas accessible depuis Internet. Veuillez utiliser la méthode des fichiers de transaction ou Hedwig pour l\'envoi et la réception de Mugle.',
      failed3: 'Impossible d\'obtenir votre adresse IP, veuillez réessayer plus tard',
      failed4: 'L\'écoute HTTP locale est en cours (http://127.0.0.1:6815). Cependant, votre adresse IP publique n\'est pas accessible depuis Internet. Veuillez utiliser la méthode des fichiers de transaction ou Hedwig pour l\'envoi et la réception de Mugle.',
    ...
    hedwig: {
      ...
      intro2: 'Lorsque quelqu\'un envoie des Mugle à cette adresse, Hedwig(v1) transmet la requête à votre portefeuille Thestral pour procéder à la transaction.',
      start: 'Démarrer',
      ...
      failed3: 'Échec de démarrage du service de réception de Mugle local. Veuillez redémarrez le portefeuille ou réessayer plus tard.',
    ...
    check: {
      ...
      intro1: 'Lorsque le solde de votre portefeuille local est en incohérence avec le solde de la blockchain Mugle (peut-être en raison de l\'annulation de la transaction ou de l\'échec de l\'envoi), vous pouvez utiliser la fonction "Synchroniser le solde".',
      intro2: 'Pendant la synchronisation, parmi toutes les sorties de transaction de solde (UXTOs) de la blockchain Mugle, trouvez les sorties non dépensées que vous pouvez utiliser et ajoutez-les pour obtenir votre solde.',
    ...
    gnode:{
      ...
      connectedCount: 'Nombre de noeuds Mugle connectés',
      ...
      removeConfirm: 'Êtes-vous sûr de vouloir supprimer les données actuelles du bloc Mugle ?'
    },
    ...
    gnodeConfig:{
      ...
      background: '(Recommandé) Poursuivre l\'exécution du noeud Mugle en arrière-plan à la fermeture de Thestral.',
    ...
    gnodeConfigModal:{
      config: 'Configurer du noeud Mugle local',
      title: 'Configurer le noeud Mugle'
    },
    ...
    tor:{
      ...
      tip: 'Veuillez garder le portefeuille en ligne durant la réception de Mugle',
      ...
      intro2: 'Envoyer/recevoir des Mugle via Tor est securisé, anonyme et décentralisé',
    ...
    gaddress:{
      ...
      tips: 'L\'adresse Slatepack est utilisée pour crypter la transaction et créer une preuve de paiement. Elle n\'est pas stockée sur la blockchain Mugle.'
    },

    log: {
      title: 'Exporter le journal',
      saveMsg: "Exporter le journal du portefeuille Thestral.",
    }
