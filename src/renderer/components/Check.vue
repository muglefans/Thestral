...
import {mugleNode2, mugleLocalNode} from '../../shared/config'
...
export default {
  ...
  methods: {
    start(){
      ...
      this.$log.debug('check mugle local status before check balance: ' + localGnodeStatus)
      ...
      this.$walletServiceV3.scanWallet(this.updateOutput)
    },
